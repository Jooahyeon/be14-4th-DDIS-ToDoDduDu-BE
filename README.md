...
<details>
  ...
  ![systemarch](https://github.com/user-attachments/assets/27297ef1-f687-49a3-a9a3-c3f00c6bf6a1)
...
### 📌 FACTS (객관적 사실)
- 모집 게시글 API를 Spring Boot로 구현하며 백엔드의 주요 로직을 담당했다.
...
### 💭 FEELINGS (느낀점 및 주관)
- 협업 프로젝트는 개인이 잘하는 것보다, 모든 팀원이 함께 흐름이 연결되는 서비스를 만드는 것이 중요함을 느꼈다.

- 모집 게시글 기능과 공동 Todo방 기능은 긴밀하게 연결되어 있어, 개발 전 사전 기획 및 소통이 매우 중요하다는 걸 체감했다.
...
- 코딩 중 막히는 부분이 있을 때는 혼자 오래 고민하기보다는 빠르게 물어보고 해결하는 적극적인 태도가 효율적일 수 있음을 깨달았다.
